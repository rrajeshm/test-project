...
def test_rtc9802_tc_des_009_mce_ni_block_in_progress_recording():
    """
    Block traffic on the outgoing MCE interface after recording starts and unblock before recording ends

...
@pytest.mark.skip(reason="Defect CSCvd04491, CSCvd85044 created for this failed Test case")
def test_rtc9815_tc_des_007_dcm_multi_cast_ip_packet_latency_recording():
    """
    Introduce the latency on each packet on the incoming MCE Interface, trigger a recording and verify if the
    ...
    try:
        ...
        for mce_node in mce_nodes:
            ...
            des_cmd = DestructiveTesting.PACKET_LATENCY_INCOMING_INTERFACE.format(DestructiveTesting.IFB_INTERFACE,

...
def test_rtc9753_tc_rec_006_current_start_time_future_end_time(stream):
    """
    Create a recording with current start time and future end time
    """
    recording = None
    ...
    try:
        ...
        recording = recording_model.Recording(EndTime=end_time, StreamId=stream)
        ...
        is_valid, status = validate_recordings.validate_recording(recording_id, web_service_obj)

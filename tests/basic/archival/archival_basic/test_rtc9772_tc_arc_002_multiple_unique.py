...
def test_rtc9772_tc_arc_002_multiple_unique(stream):
    """
    Create multiple recordings with copy type as UNIQUE and verify whether only one copy of the recording is archived
    """
    total_recordings = 3
    recording = None
    web_service_objs = []

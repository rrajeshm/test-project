...
def test_rtc9776_tc_arc_006_playback_after_archive_complete(stream):
    """
    Create a recording with copy type as UNIQUE and play it back after archival completes
    """
    recording = None

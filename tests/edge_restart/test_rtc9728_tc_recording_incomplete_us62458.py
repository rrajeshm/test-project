...
TC_ER_003_004_DATA = [("rtc9728_bulk_recordings_unique", RecordingAttribute.COPY_TYPE_UNIQUE)]

@utils.test_case_logger
@pytest.mark.parametrize("name, copy_type", TC_ER_003_004_DATA, ids=[x[0] for x in
                                                                      TC_ER_003_004_DATA])

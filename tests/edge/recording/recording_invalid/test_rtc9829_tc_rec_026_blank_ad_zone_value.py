...
def test_rtc9829_tc_rec_026_blank_ad_zone_value(stream):
    ...
    """
    recording = recording_model.Recording(AdZone=constants.BLANK, StreamId=stream)
    ...
    is_valid, error = validate_recordings.validate_recording_error_code(response, RecordingError.INVALID_AD_ZONE)

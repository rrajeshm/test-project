...
def test_rtc9824_tc_rec_021_invalid_end_time(stream):
    """
    Schedule a recording with an invalid end time
    """
    recording = recording_model.Recording(EndTime=constants.INVALID_TIME, StreamId=stream)

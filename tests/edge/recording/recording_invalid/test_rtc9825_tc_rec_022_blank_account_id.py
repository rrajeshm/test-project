...
def test_rtc9825_tc_rec_022_blank_account_id(stream):
    ...
    """
    recording = recording_model.Recording(AccountId=constants.BLANK, StreamId=stream)
    ...
    is_valid, error = validate_recordings.validate_recording_error_code(response, RecordingError.MISSING_ACCOUNT_ID)

...
def test_rtc9822_tc_rec_019_invalid_copy_type(stream):
    ...
    """
    recording = recording_model.Recording(copyType=constants.INVALID, StreamId=stream)
    ...
    is_valid, error = validate_recordings.validate_recording_error_code(response, RecordingError.INVALID_COPY_TYPE)

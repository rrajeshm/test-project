...
def test_rtc9817_tc_rec_005_past_start_time_past_end_time(stream):
    """
    Create a recording with past start time and past end time
    """
    recording = None
    web_service_obj = None

    try:
        start_time = utils.get_formatted_time(constants.SECONDS * -180, TimeFormat.TIME_FORMAT_MS, stream)
